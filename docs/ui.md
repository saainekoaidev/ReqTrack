...
| S03 | ガントチャート | `/gantt` | 見積からガント初版を生成し計画/進捗を時系列表示 (US-004) | 実装済 |
| S04 | マスタ登録 | `/masters` | 要員(US-005)・祝日(US-006)の登録/一覧/削除 | 実装済 |
| S05 | 進捗報告 | `/reports` | 要員がタスクの進捗率を報告 | 未着手 |
| S06 | 遅延ダッシュボード | `/delays` | 遅延タスク・遅れ要員・リカバリ案 | 未着手 |
