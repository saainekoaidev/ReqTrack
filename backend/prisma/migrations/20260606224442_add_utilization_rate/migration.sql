...
INSERT INTO "new_Task" ("assigneeId", "createdAt", "estimateDays", "id", "name", "plannedEnd", "plannedStart", "progress", "projectId", "requirementId", "updatedAt") SELECT "assigneeId", "createdAt", "estimateDays", "id", "name", "plannedEnd", "plannedStart", "progress", "projectId", "requirementId", "updatedAt" FROM "Task";
DROP TABLE "Task";
